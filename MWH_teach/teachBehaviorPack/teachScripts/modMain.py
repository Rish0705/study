...
@Mod.Binding(name = modConfig.modName, version = modConfig.version)
class MwhModInit(object):
    ...
    def TutorialServerInit(self):
        ...
        serverApi.RegisterSystem(modConfig.modName, modConfig.serverName, modConfig.serverSystem)
    ...
    def TutorialClientInit(self):
        ...
        # 取名名称尽量个性化，不能与其他人的MOD冲突，可以使用英文、拼音、下划线这三种。
        clientApi.RegisterSystem(modConfig.modName, modConfig.clientName, modConfig.clientSystem)
